# Building UETN eduroam2go image using imagebuilder - GL.iNet GL-AR750S #
...
wget https://downloads.openwrt.org/releases/22.03.5/targets/ath79/nand/openwrt-imagebuilder-22.03.5-ath79-nand.Linux-x86_64.tar.xz

tar -J -x -f openwrt-imagebuilder-22.03.5-ath79-nand.Linux-x86_64.tar.xz

cd openwrt-imagebuilder-22.03.5-ath79-nand.Linux-x86_64/
...
scp bin/targets/ username@(host):~

#now flash  to the GL.iNet GL-AR750S and boot
```

== Extra Notes ==

=== Info about "Stock" OpenWRT Image ===
Image - https://downloads.openwrt.org/releases/22.03.5/targets/ath79/nand/openwrt-22.03.5-ath79-nand-glinet_gl-ar750s-nor-nand-squashfs-sysupgrade.bin
...
fstab.@mount[0].uuid='bc03e97f-9e74-42dc-acce-6c32f653b29e'
...
network.globals.ula_prefix='fd44:4cf4:be16::/48'
